...
export default function AudioSessionEndedPage() {
  ...
  const statusStyles = isCompleted
    ? { icon: "text-green-500", badgeBg: "bg-green-500/10" }
    : { icon: "text-red-500", badgeBg: "bg-red-500/10" };

  const description = isCompleted
    ? "This audio session has successfully finished."
