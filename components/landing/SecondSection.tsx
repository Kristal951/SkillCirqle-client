...
import HandShake from "@material-symbols/svg-400/outlined/handshake.svg";
          ...
          {cardDetails.map((card, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-text-primary/10 rounded-xl flex items-center justify-center text-text-primary mb-5">
